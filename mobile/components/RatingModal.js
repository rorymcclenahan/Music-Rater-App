...
export default class SongModal extends Component {
  ...
  handleChange = (name, field) => {
    ...
    this.setState({ activeRating: {
        id : this.state.activeRating.id,
        rating : field,
        artist : this.state.activeRating.artist,
        song : this.state.activeRating.song,
        song_artist : this.state.activeRating.song_artist,
        }
      });
    // } else if (name == "artist") {
    ...
    //         });
        // }
    // console.log("handleChange", this.state.activeRating);
  };
  ...
  onSave = (song) => {
    ...
    if (song.song == "") {
      ...
      this.props.handleSubmit(this.props.activeRating);
    }
  };
  render() {
    return (
            ...
            <View style={styles.modalView}>
              ...
              <View style={styles.buttonView}>
                <Pressable
                  ...
                  onPress={() => this.props.handleSubmit(this.state.activeRating)}
                >
